...
target: `ssl` — the whole `ssl/` dir of openssl, plus the headers outside it
        that libssl itself implements (see `oracle-config.json`)
max-syms: default
max-loc: default
max-types: 1
...
```
crustify-oracle /work/<openssl-checkout> ssl schedule \
    --output /work/raw-void.json --lifetime-for void
crustify-cli /work/<openssl-checkout> ssl translate \
    /work/raw-void.json --objective wrap
crustify-oracle /work/<openssl-checkout> ssl schedule \
    --output /work/raw-string.json --lifetime-for string
crustify-cli /work/<openssl-checkout> ssl translate \
    /work/raw-string.json --objective wrap
```
...
```
crustify-oracle /work/<openssl-checkout> ssl schedule \
    --output /work/types-l0.json --name \
...
crustify-cli /work/<openssl-checkout> ssl translate \
    /work/types-l0.json --objective wrap
```
...
```
crustify-oracle /work/<openssl-checkout> ssl schedule \
    --output /work/imports-l1.json --name \
...
crustify-cli /work/<openssl-checkout> ssl translate \
    /work/imports-l1.json --objective wrap
```
...
```
crustify-oracle /work/<openssl-checkout> ssl schedule \
    --output /work/imports-l2-wrap-l0.json --name \
...
crustify-cli /work/<openssl-checkout> ssl translate \
    /work/imports-l2-wrap-l0.json --objective wrap
```
...
```
crustify-oracle /work/<openssl-checkout> ssl schedule \
    --output /work/imports-l2-wrap-l1.json --name \
...
crustify-cli /work/<openssl-checkout> ssl translate \
    /work/imports-l2-wrap-l1.json --objective wrap
```
...
crustify-oracle /work/<openssl-checkout> ssl schedule \
    ...
    --name record_layer_st quic_stream_st ssl_session_st --transitive
crustify-cli /work/<openssl-checkout> ssl translate \
